            ...
            <div class="col-sm-2 text-right">
              <span style="margin-right: 15px">
                <div class="col-sm-3" style="float:right;">
                  <a href="<?=base_url('donnees/Electeurs/ajouter')?>" style="width: 100px;" class='btn btn-primary btn-sm float-right'>
...
< <script type="text/javascript">
  ...
  <script type="text/javascript">
    ...
    Swal.fire({
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>donnees/Electeurs/activer/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
 ...
 function desactiver(id,nom=null,prenom=null){
    Swal.fire({
      ...
      /* Debut ajax*/
         $.ajax({
          url : "<?=base_url()?>donnees/Electeurs/desactiver/"+id,
          type : "PUT",
          dataType: "JSON",
          cache:false,
          data: {},
